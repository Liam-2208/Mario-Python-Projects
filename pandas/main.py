...
def main_menu():
    options: list[str] = ["Total income by source"]
    choice: str = ""
...
if main_menu_choice == 0:
    ...
    total_choice = convert_total_menu_choice(total_men_choice)
